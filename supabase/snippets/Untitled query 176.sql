...
-- ลบ function เดิมก่อน (ถ้ามี) เพื่อให้สามารถเปลี่ยน return type ได้
DROP FUNCTION IF EXISTS public.get_stores_by_distance(NUMERIC, NUMERIC, INTEGER, INTEGER, UUID);
